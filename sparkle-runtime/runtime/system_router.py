...
_CRONS = [
    ...
    {"name": "content_pipeline_tick", "schedule": "every 5min"},
    {"name": "content_publisher_tick","schedule": "every 1h"},
    {"name": "content_brain_sync",    "schedule": "daily 3h Brasilia"},
    {"name": "content_stuck_check",   "schedule": "every 30min"},
